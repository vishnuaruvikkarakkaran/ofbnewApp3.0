...
public class PopularCoursesListPresenter extends BasePresenter implements PopularCoursesListContract.Presenter {
    ...
    public PopularCoursesListPresenter(Context context, PopularCoursesListContract.View mView) {
        this.mView = mView;
    ...
    @Override
    public void getpopularcourses(Context context, String categoryIDs, int offset) {
