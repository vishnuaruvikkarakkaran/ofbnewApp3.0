...
public abstract class BaseRecyclerviewAdapter<T, L extends BaseRecyclerViewListener,
        VH extends BaseViewHolder<T, L>> extends RecyclerView.Adapter<VH> {
    ...
    public void setItems(List<T> items) {
        if (items == null) {
            throw new IllegalArgumentException("Cannot set `null` item to the Recyclerview adapter");
        }
        this.items.clear();
    ...
    public void add(T item) {
        if (item == null) {
            throw new IllegalArgumentException("Cannot add null item to the Recyclerview adapter");
        }
        items.add(item);
    ...
    public void addAll(List<T> items) {
        if (items == null) {
            throw new IllegalArgumentException("Cannot add `null` items to the Recyclerview adapter");
        }
        this.items.addAll(items);
