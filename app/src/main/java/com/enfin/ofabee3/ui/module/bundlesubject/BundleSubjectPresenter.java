...
public class BundleSubjectPresenter extends BasePresenter implements BundleSubjectContract.Presenter {
    ...
    public BundleSubjectPresenter(BundleSubjectContract.View mView, Context mContext) {
        this.mView = mView;
        this.mContext = mContext;
    }

    @Override
    public void getCourseDetail(Activity context, String courseID, String type) {
